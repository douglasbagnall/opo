...
dest = (sys.argv + ['/tmp/test.avi'])[1]


#p = opo_launcher.start_stitching_process(dest, TEST_VIDEOS[:4], 352, 288)
p = opo_launcher.start_stitching_process(dest, TEST_VIDEOS[:4], 256, 192, 3)
